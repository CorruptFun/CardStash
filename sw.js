...
const PRECACHE = ["./assets/cloud-V-rl-6hN.js","./assets/ibm-plex-mono-latin-500-normal-DSY6xOcd.woff2","./assets/ibm-plex-mono-latin-600-normal-BgSNZQsw.woff2","./assets/index-Dz4um2Fw.css","./assets/index-pSisjx7L.js","./assets/inter-latin-ext-wght-normal-DO1Apj_S.woff2","./assets/inter-latin-wght-normal-Dx4kXJAl.woff2","./assets/tesseract.esm.min-CZ9ajNVL.js","./favicon.svg","./icons/apple-touch-icon.png","./icons/icon-192.png","./icons/icon-512.png","./icons/maskable-512.png","./index.html","./index.html","./manifest.webmanifest"];
const IMG_LIMIT = 480;
