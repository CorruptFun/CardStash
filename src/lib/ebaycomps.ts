...
/**
 * Forget cached comps and the quota stand-down. Not yet wired into Settings'
 * clear-caches path -- rows expire by TTL regardless, so nothing depends on
 * this being called; it exists for that wiring when someone adds it.
 */
